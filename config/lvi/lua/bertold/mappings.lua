...
vim.keymap.set('i', '<c-j>', '<esc>I', nore)
vim.keymap.set('i', '<c-k>', '<esc>A', nore)
vim.keymap.set('i', '<c-o>', '<esc>o<up><esc>A', nore)
vim.keymap.set('n', '<c-m>', 'm', nore)
...
vim.keymap.set('n', 'YY', '<cmd>%y<CR>', nore)

-- Emmet
vim.keymap.set('i', '<c-g>', '<Plug>(emmet-expand-abbr)', nore)
